...
--
-- Host: localhost    Database: ry-gvp
-- ------------------------------------------------------
...
--
-- Table structure for table `gvp_adverse_reaction`
--

DROP TABLE IF EXISTS `gvp_adverse_reaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_adverse_reaction` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '不良反应ID',
  `doctor_id` bigint NOT NULL COMMENT '医生ID',
  `patient_id` bigint NOT NULL COMMENT '患者ID',
  `drug_id` bigint NOT NULL COMMENT '药品ID',
  `description` varchar(200) DEFAULT NULL COMMENT '反应描述',
  `severity` varchar(20) DEFAULT NULL COMMENT '严重程度(轻微/中度/严重)',
  `occur_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '发生时间',
  `doctor_confirmed` tinyint DEFAULT '0' COMMENT '医生是否确认(0否 1是)',
  PRIMARY KEY (`id`),
  KEY `idx_patient_id` (`patient_id`),
  KEY `idx_drug_id` (`drug_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='不良反应表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_adverse_reaction`
--

LOCK TABLES `gvp_adverse_reaction` WRITE;
/*!40000 ALTER TABLE `gvp_adverse_reaction` DISABLE KEYS */;
INSERT INTO `gvp_adverse_reaction` VALUES (5,108,106,1,'点点滴滴大大的','轻微','2025-09-25 10:33:58',0);
/*!40000 ALTER TABLE `gvp_adverse_reaction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_adverse_reaction_feedback`
--

DROP TABLE IF EXISTS `gvp_adverse_reaction_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_adverse_reaction_feedback` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '反馈ID',
  `reaction_id` bigint NOT NULL COMMENT '不良反应ID',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_reaction_id` (`reaction_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='不良反应反馈表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_adverse_reaction_feedback`
--

LOCK TABLES `gvp_adverse_reaction_feedback` WRITE;
/*!40000 ALTER TABLE `gvp_adverse_reaction_feedback` DISABLE KEYS */;
INSERT INTO `gvp_adverse_reaction_feedback` VALUES (2,5,108,'事实上事实上事实上飒飒飒',NULL);
/*!40000 ALTER TABLE `gvp_adverse_reaction_feedback` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_drug`
--

DROP TABLE IF EXISTS `gvp_drug`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_drug` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '药品ID',
  `drug_name` varchar(100) NOT NULL COMMENT '药品名称',
  `description` varchar(200) DEFAULT NULL COMMENT '药品描述',
  `indications` varchar(100) DEFAULT NULL COMMENT '药品适应症',
  `precautions` varchar(100) DEFAULT NULL COMMENT '药品注意事项',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='药品信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_drug`
--

LOCK TABLES `gvp_drug` WRITE;
/*!40000 ALTER TABLE `gvp_drug` DISABLE KEYS */;
INSERT INTO `gvp_drug` VALUES (1,'阿莫西林','四十','随机事件','四十');
/*!40000 ALTER TABLE `gvp_drug` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_drug_instruction`
--

DROP TABLE IF EXISTS `gvp_drug_instruction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_drug_instruction` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '说明书ID',
  `drug_id` bigint NOT NULL COMMENT '药品ID',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_drug_id` (`drug_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='药品说明书表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_drug_instruction`
--

LOCK TABLES `gvp_drug_instruction` WRITE;
/*!40000 ALTER TABLE `gvp_drug_instruction` DISABLE KEYS */;
INSERT INTO `gvp_drug_instruction` VALUES (1,1,'内容1等等的点点滴滴我问问','V1.0','2025-09-24 15:43:47');
/*!40000 ALTER TABLE `gvp_drug_instruction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_medication_log`
--

DROP TABLE IF EXISTS `gvp_medication_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_medication_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '服药打卡ID',
  `record_id` bigint NOT NULL COMMENT '用药记录ID',
  `take_time` datetime NOT NULL COMMENT '服药时间',
  `is_taken` tinyint DEFAULT '1' COMMENT '是否服药(1已服 0未服)',
  PRIMARY KEY (`id`),
  KEY `idx_record_id` (`record_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='服药打卡记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_medication_log`
--

LOCK TABLES `gvp_medication_log` WRITE;
/*!40000 ALTER TABLE `gvp_medication_log` DISABLE KEYS */;
INSERT INTO `gvp_medication_log` VALUES (1,1,'2025-09-25 00:00:00',1);
/*!40000 ALTER TABLE `gvp_medication_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_medication_record`
--

DROP TABLE IF EXISTS `gvp_medication_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_medication_record` (
  ...
  `status` tinyint DEFAULT '1' COMMENT '状态(1使用中 0已结束)',
  PRIMARY KEY (`id`),
  KEY `idx_patient_id` (`patient_id`),
  KEY `idx_drug_id` (`drug_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='患者用药记录表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_medication_record`
--

LOCK TABLES `gvp_medication_record` WRITE;
/*!40000 ALTER TABLE `gvp_medication_record` DISABLE KEYS */;
INSERT INTO `gvp_medication_record` VALUES (1,1,1,'10mg','一日四次','2025-09-17','2025-09-30',1),(2,2,1,'20mg','一日一次','2025-09-30','2025-10-31',1);
/*!40000 ALTER TABLE `gvp_medication_record` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_patient`
--

DROP TABLE IF EXISTS `gvp_patient`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_patient` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '患者ID',
  `user_id` bigint NOT NULL COMMENT '关联用户ID(小程序端)',
  ...
  `history` varchar(200) DEFAULT NULL COMMENT '过敏史/病史',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='患者信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_patient`
--

LOCK TABLES `gvp_patient` WRITE;
/*!40000 ALTER TABLE `gvp_patient` DISABLE KEYS */;
INSERT INTO `gvp_patient` VALUES (1,106,108,'002',31,'M','快快快'),(2,109,108,'003',80,'F','无，点击季度会度U盾胡定');
/*!40000 ALTER TABLE `gvp_patient` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gvp_pharmaceutical`
--

DROP TABLE IF EXISTS `gvp_pharmaceutical`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gvp_pharmaceutical` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '药厂ID',
  `name` varchar(100) NOT NULL COMMENT '药厂名称',
  `address` varchar(200) DEFAULT NULL COMMENT '地址',
  `contact` varchar(50) DEFAULT NULL COMMENT '联系方式',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='药厂信息表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gvp_pharmaceutical`
--

LOCK TABLES `gvp_pharmaceutical` WRITE;
/*!40000 ALTER TABLE `gvp_pharmaceutical` DISABLE KEYS */;
/*!40000 ALTER TABLE `gvp_pharmaceutical` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sys_dept` VALUES (100,0,'0','XXX第一人民医院',0,'李院长','15888888888','ry@qq.com','0','0','admin','2024-02-28 22:23:42','admin','2025-09-23 15:37:24'),(101,100,'0,100','深圳总公司',1,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(102,100,'0,100','长沙分公司',2,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(103,101,'0,100,101','研发部门',1,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(104,101,'0,100,101','市场部门',2,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(105,101,'0,100,101','测试部门',3,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(106,101,'0,100,101','财务部门',4,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(107,101,'0,100,101','运维部门',5,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(108,102,'0,100,102','市场部门',1,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(109,102,'0,100,102','财务部门',2,'若依','15888888888','ry@qq.com','0','2','admin','2024-02-28 22:23:42','',NULL),(200,100,'0,100','骨科',1,NULL,NULL,NULL,'0','0','admin','2025-01-09 09:56:28','admin','2025-09-23 15:37:32'),(201,100,'0,100','呼吸科',2,NULL,NULL,NULL,'0','0','admin','2025-01-09 09:56:48','admin','2025-09-23 15:37:38');
...
INSERT INTO `sys_notice` VALUES (1,'欢迎大家使用','2',_binary '<p>GVP管理平台开放，欢迎大家使用</p>','0','admin','2024-02-28 22:23:43','admin','2025-09-26 10:07:13','管理员'),(2,'系统维护公告','1',_binary '<p>GVP管理系统维护中，两天后正常开放</p>','0','admin','2024-02-28 22:23:43','admin','2025-09-26 10:07:24','管理员');
...
) ENGINE=InnoDB AUTO_INCREMENT=343 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'游客','tourist',2,'2',0,1,'0','2','admin','2024-02-28 22:23:42','admin','2024-04-18 15:06:26','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','2','admin','2024-02-28 22:41:12','admin','2024-03-10 11:35:10',NULL),(101,'普通用户','common',4,'1',1,1,'0','2','admin','2024-02-28 22:41:32','admin','2024-03-09 18:14:20','普通用户'),(102,'医生','doctor',3,'1',0,1,'0','0','admin','2025-01-08 10:15:29','admin','2025-09-28 15:26:40',NULL),(103,'患者','patient',4,'1',0,1,'0','0','admin','2025-01-08 10:16:01','admin','2025-09-28 15:26:45',NULL);
...
INSERT INTO `sys_role_menu` VALUES (102,1035),(102,2056),(102,2057),(102,2058),(102,2059),(102,2061),(102,2062),(102,2063),(102,2064),(102,2065),(102,2066),(102,2069),(102,2071),(102,2076),(102,2077),(102,2078),(102,2079),(102,2080),(102,2084),(102,2085),(102,2086),(102,2087),(102,2088),(102,2089),(102,2090),(102,2091),(102,2092),(103,1035),(103,2058),(103,2059),(103,2061),(103,2063),(103,2069),(103,2071),(103,2079),(103,2081),(103,2082),(103,2083),(103,2084),(103,2085),(103,2086),(103,2088);
...
--
-- Dumping routines for database 'ry-gvp'
--
...
-- Dump completed on 2025-09-28 16:49:31
